...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankClient::stTrnsferHistoryRecord TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferHistoryScreen()
    {
        ...
        vector <clsBankClient::stTrnsferHistoryRecord> vTransferLogRecord = clsBankClient::GetTransfersLogList();

        string Title = "\tTransfer History List Screen";
        ...
        if (vTransferLogRecord.size() == 0)
            ...
            for (clsBankClient::stTrnsferHistoryRecord Record : vTransferLogRecord)
            {
